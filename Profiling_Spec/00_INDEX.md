...
|----------|-------------|
| [Architecture Overview](./01_ARCHITECTURE_OVERVIEW.md) | System design, deployment, design decisions |
| [Core Domain Model](./02_CORE_DOMAIN_MODEL.md) | → 已整合至 04_DATABASE_SCHEMA.md |
| [Modules and Boundaries](./03_MODULES_AND_BOUNDARIES.md) | Module decomposition, RBAC, data flow |

### Technical Specifications

| Document | Description |
|----------|-------------|
| [Database Schema](./04_DATABASE_SCHEMA.md) | **Main reference** - Tables, ERD, enums, business logic |
| [API Specification](./05_API_SPECIFICATION.md) | Complete REST API reference (250+ endpoints) |
| [Permissions & RBAC](./06_PERMISSIONS_RBAC.md) | → 已整合至 03_MODULES_AND_BOUNDARIES.md |

### Module Specifications

| Document | Description |
|----------|-------------|
| [Audit & Logging](./07_AUDIT_LOGGING.md) | GLP-compliant activity tracking |
| [HR Module](./08_ATTENDANCE_MODULE.md) | Business rules for attendance, leave, overtime |
| [Extensibility](./09_EXTENSIBILITY.md) | Extension points, future expansion |

### Guidelines

| Document | Description |
|----------|-------------|
| [UI/UX Guidelines](./10_UI_UX_GUIDELINES.md) | Design patterns, components |
| [Naming Conventions](./11_NAMING_CONVENTIONS.md) | Code naming standards |
| [Version History](./12_VERSION_HISTORY.md) | Document changelog |
