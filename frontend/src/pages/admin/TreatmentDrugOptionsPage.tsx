        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3 items-center bg-white p-4 rounded-lg border">
                <div className="flex gap-2 flex-1 min-w-[200px]">
                    ...
                    <Button type="button" variant="secondary" onClick={() => queryClient.invalidateQueries({ queryKey: ['admin-treatment-drugs'] })} aria-label="搜尋" className="cursor-pointer transition-colors hover:bg-secondary/70 hover:ring-2 hover:ring-primary/20 hover:ring-offset-2">
