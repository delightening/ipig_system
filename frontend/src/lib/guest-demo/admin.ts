...
export const DEMO_AUDIT_LOGS: PaginatedResponse<UserActivityLog> = {
  data: [
    ...
    },
    {
      ...
      after_data: { weight: 28.5 }, changed_fields: ['weight'],
      ip_address: '192.168.1.101', user_agent: 'Mozilla/5.0', request_path: '/api/animals/records',
    ...
    },
    {
      ...
      after_data: { recommendation: '持續觀察' }, changed_fields: ['recommendation'],
      ip_address: '192.168.1.102', user_agent: 'Mozilla/5.0', request_path: '/api/animals/vet-recommend',
      is_suspicious: false, suspicious_reason: null, created_at: '2026-03-30T15:00:00Z',
      integrity_hash: 'demo-hash-3', previous_hash: 'demo-hash-2', impersonated_by_user_id: 'demo-admin', hmac_version: 2,
    },
  ],
