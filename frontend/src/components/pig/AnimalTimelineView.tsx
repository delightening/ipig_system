import { Pig, PigObservation, PigSurgery, PigWeight, RecordType, recordTypeNames } from '@/lib/api'
...
export function AnimalTimelineView({
    ...
    const timelineItems: TimelineItem[] = [
        ...
        ...(pig ? [{
            ...
            date: new Date(pig.entry_date || pig.created_at),
            title: '資料建立',
            content: `耳號 ${pig.ear_tag} 進場${pig.entry_weight ? `，進場體重 ${pig.entry_weight} kg` : ''}`,
