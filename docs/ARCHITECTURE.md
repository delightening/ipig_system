...
sequenceDiagram
    ...
    Note over MW: Write endpoints: 120/min<br/>Upload endpoints: 30/min<br/>Auth endpoints: 100/min<br/>General API: 600/min
```
...
| **狀態管理** | Zustand (auth), TanStack Query (server state) |
...
| **CI/CD** | GitHub Dependabot, cargo-chef 快取 |
