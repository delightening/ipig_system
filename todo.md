...
### 資料庫與後端
- [ ] UUID 遷移完整測試 - 執行資料庫遷移並進行端對端測試
- [ ] Docker 建置測試 - 確認後端與前端建置成功

### 動物管理系統
- [ ] Emergency Medication UI 完善 - 整合對話框與後端通知
- [ ] Euthanasia Workflow UI 完善 - PI 申訴與 CHAIR 仲裁流程
- [ ] Quick Add Animal Dialog 測試 - 驗證耳標格式化與動物建立功能

### AUP 審查系統
- [ ] AUP 表單英文翻譯驗證 - 確認 Section 2-10 翻譯完整性
- [ ] Reviewer Anonymization 測試 - 驗證 PI/CLIENT 視角顯示 "Reviewer A/B/C"

### 權限管理
- [ ] 權限分類整合驗證 - 確認「其他」分類無重複，CRUD 操作正確分組
