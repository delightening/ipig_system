...
def create_approved_protocol(t) -> str:
    ...
    content = {
        "basic": {
            ...
            "pi": {"name": "PI", "phone": "0912-000-000", "email": "pi@test.com", "address": "台北市"},
            "sponsor": {"name": "測試研究基金會", "contact_person": "王測試", "contact_phone": "02-0000-0000", "contact_email": "s@test.com"},
...
def run_amendment_test() -> bool:
    ...
    # ========================================
    # Step 2: PI 建立 Amendment (Minor 路線)
    # ========================================
    t.step("PI 建立 Amendment（Minor 路線）")
    ts = int(time.time())
    ...
    # ========================================
    # Step 5: PI 建立 Amendment (Major 路線)
    # ========================================
    t.step("PI 建立 Amendment（Major 路線）")
    ...
    # ========================================
    # Step 9: 審查委員記錄決定（全部核准 → 自動 APPROVED）
    # ========================================
    t.step("審查委員記錄決定（全部核准）")
