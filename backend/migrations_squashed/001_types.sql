-- ============================================
-- Migration 001: Custom Types & Extensions
-- Squashed from: 001, 009, 018
-- ============================================
...
CREATE TYPE notification_type AS ENUM (
    ...
    'system_alert', 'monthly_report', 'equipment_overdue', 'equipment_unrepairable', 'equipment_disposal'
);
...
-- Equipment Maintenance (from 018)
