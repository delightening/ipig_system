-- ============================================
-- Migration 003: Animal Management
-- Squashed from: 004, 008(partial), 019(partial), 022(partial)
-- ============================================
...
-- 3.2 Animals (merged: 004 + 008 version + 019 pen_id/species_id)
...
-- NOTE: FK constraints for pen_id, species_id
-- are added in 008_facility_equipment.sql after the referenced tables (pens, species) exist.

-- 3.3 Observations (merged: 004 + 008 version)
...
-- 3.4 Surgeries (merged: 004 + 008 version)
...
-- 3.7 Sacrifices (merged: 004 + 008 lock columns)
...
-- 3.18 Blood test templates & panels
...
-- 3.19 Blood test presets (from 009)
...
-- 3.21 Animal transfers (merged: 004 + 008 transfer_type)
...
-- 3.22 Field correction requests
...
-- 3.23 Treatment drug options (from 008, with business key constraint from 010)
