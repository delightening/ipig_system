...
/// 匯出計畫書 PDF
#[utoipa::path(get, path = "/api/v1/protocols/{id}/export-pdf", params(("id" = Uuid, Path, description = "專案 ID")), responses((status = 200, description = "PDF 檔案")), tag = "計畫書管理", security(("bearer" = [])))]
